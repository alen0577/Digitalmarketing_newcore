# Generated by Django 4.1.2 on 2023-11-23 06:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lead_collection_for', models.CharField(blank=True, default='', max_length=255, null=True)),
                ('lc_discription', models.TextField(blank=True, default='', null=True)),
                ('lc_target', models.IntegerField(default=0)),
                ('lc_target_achived', models.IntegerField(default=0)),
                ('lc_file', models.FileField(default='', upload_to='work\\files')),
                ('lc_progress', models.IntegerField(default=0)),
                ('cTaskId', models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='DM_Head.clienttask_register')),
            ],
        ),
        migrations.CreateModel(
            name='TaskAssign',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lead_source', models.CharField(blank=True, default='', max_length=255, null=True)),
                ...
                ('lead_category_id', models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='DM_Head.leadcategory_register')),
                ...
                ('lead_taskAssignId', models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='DM_Head.taskassign')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field_lead_category', models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='DM_Head.leadcategory_register')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('lcta_discription', models.TextField(blank=True, default='', null=True)),
                ('lcta_from_date', models.DateField(null=True)),
                ('lcta_due_date', models.DateField(null=True)),
                ('lcta_target', models.IntegerField(default=0)),
                ('lcta_target_achived', models.IntegerField(default=0)),
                ('lcta_file', models.FileField(default='', upload_to='work\\files')),
                ('lcta_progress', models.IntegerField(default=0)),
                ('lcta_status', models.IntegerField(default=0)),
                ('Tl_id', models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='Registration_Login.employeeregister_details')),
                ('lc_id', models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='DM_Head.leadcategory_register')),
                ('wa_id', models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='DM_Head.workassign')),
            ],
        ),
        migrations.CreateModel(
            name='LeadCateogry_Assign',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('lca_discription', models.TextField(blank=True, default='', null=True)),
                ('lca_from_date', models.DateField(null=True)),
                ('lca_due_date', models.DateField(null=True)),
                ('lca_target', models.IntegerField(default=0)),
                ('lca_target_achived', models.IntegerField(default=0)),
                ('lca_file', models.FileField(default='', upload_to='work\\files')),
                ('lca_progress', models.IntegerField(default=0)),
                ('lca_status', models.IntegerField(default=0)),
                ('executive_id', models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='Registration_Login.employeeregister_details')),
                ('lcta_id', models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='DM_Head.leadcateogry_teamallocate')),
            ],
        ),
        migrations.CreateModel(
            name='lead_Details',
